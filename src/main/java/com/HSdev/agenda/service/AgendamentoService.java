package com.HSdev.agenda.service;

import com.HSdev.agenda.infrastructure.entity.Agendamento;
import com.HSdev.agenda.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento) {
        ...
        if (Objects.nonNull(agendados)) {
            throw new RuntimeException("Horario nao disponivel");
        }
    ...
    public Agendamento alterarAgendamento(Agendamento agendamento, String cliente, LocalDateTime dataHoraAgendamento) {
        ...
        if(Objects.isNull (agenda)) {
            throw  new RuntimeException("Horario nao prenchido");
        }
